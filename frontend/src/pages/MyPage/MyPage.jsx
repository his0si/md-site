    ...
    return (
      <>
        <Container>
            ...
            <div style={{color:" #167D4E",fontSize:"20px",fontWeight:"700",marginBottom:"10vh",marginTop:"5vh"}}>마이페이지</div>
            
                  <Link to="/my-page/list" style={{textDecoration:"none",color:"black",width:"90%"}}>
                  ...
                  <Link to="/my-page/info" style={{textDecoration:"none",color:"black",width:"90%"}}>
                  <Box>
                      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
